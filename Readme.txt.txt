Project related screenshot have been attached in zip file

GIT HUB PROJECT LINK :https://github.com/Sayali1398/DevOps_Microservices.git

1--> https://github.com/Sayali1398/DevOps_Microservices.git
	Branch : main
...
5--> Edited Dockerfile, run_docker.sh and checked it using make lint command attached the screenshot
